---
name: christian
description: "Christian (Linux-VPN- & Router-Spezialist) direkt aufrufen — mit optionalem Auftrag"
---

Spawne den `christian:christian`-Agenten und übergib den User-Text als Arbeitsauftrag.
...
Kein Text angegeben: Christian ohne Auftrag spawnen — er fragt nach Ziel (VPN/Router/WAN),
Endpunkten/Netzen und Plattform.
