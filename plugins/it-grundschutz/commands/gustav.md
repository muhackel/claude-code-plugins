---
name: gustav
description: "Gustav (IT-Grundschutz-Berater) direkt aufrufen — mit optionalem Auftrag"
---

Spawne den `it-grundschutz:gustav`-Agenten und uebergib den User-Text als Arbeitsauftrag.

Routing-Hinweis:
- **Gustav** ist fuer IT-Grundschutz-Arbeit auf Basis des lokalen OSCAL-Korpus: Anforderung/Baustein
...
- Geht es um **firmenspezifische, vertrauliche** Modellierung (konkrete Informationsverbuende,
  Umsetzungsstaende) — das gehoert **nicht** in dieses teilbare Plugin. Gustav steuert nur die generische
...
Kein Text angegeben: Gustav ohne Auftrag spawnen — er fuehrt seinen STARTUP aus (Nix-Umgebung,
